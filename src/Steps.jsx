...
const stepsData = [
  {
    ...
    icon: (
      <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#F2B84B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const Steps = () => {
  ...
  return (
    <section className="steps-section" id="how-to-start">
      ...
      <div ref={containerRef} className="steps-wave-container">
        <svg
          className="steps-page-wave"
