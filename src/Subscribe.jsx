...
export default function Subscribe({ onOpenQrSidebar, onNavigateRoute, onOpenCheckoutModal }) {
  ...
  const handleSubscribeClick = () => {
    if (onOpenCheckoutModal) {
      onOpenCheckoutModal(billingCycle);
    }
  };
  ...
  return (
    <div className="policy-page">
        ...
        <section className="sub-hero">
          <div className="sub-hero-title-group">
            <h1 className="sub-hero-title-line">
              <span className="sub-hero-title-break">Choose Your</span>
          ...
          <div className="sub-hero-bottom-row">
            ...
            <p className="sub-hero-desc">
              When you tap Subscribe Now, you'll sign in with mobile OTP (the same mobile number you use in the app), then pay securely with Razorpay.
            </p>
      ...
      <Footer onOpenQrSidebar={onOpenQrSidebar} onNavigateRoute={onNavigateRoute} currentPath="/subscribe" />
    </div>
  );
}
